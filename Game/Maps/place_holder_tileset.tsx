...
<tileset version="1.10" tiledversion="1.12.2" name="place_holder_tileset" tilewidth="16" tileheight="16" tilecount="22" columns="0">
 ...
 <tile id="10" type="Kill">
  <image source="../Images/Tiles/Red - Copy - Copy (2).png" width="16" height="16"/>
 </tile>
 <tile id="11" type="Kill">
  <image source="../Images/Tiles/Red - Copy - Copy.png" width="16" height="16"/>
 </tile>
 <tile id="12" type="Kill">
  <image source="../Images/Tiles/Red - Copy.png" width="16" height="16"/>
 </tile>
 <tile id="13">
  <image source="../Images/Tiles/Tile br.png" width="16" height="16"/>
 </tile>
 <tile id="14">
  <image source="../Images/Tiles/Tile tr.png" width="16" height="16"/>
 </tile>
 <tile id="15">
  <image source="../Images/Tiles/Tile_bl.png" width="16" height="16"/>
 </tile>
 <tile id="16">
  <image source="../Images/Tiles/Tile_down.png" width="16" height="16"/>
 </tile>
 <tile id="17">
  <image source="../Images/Tiles/Tile_left.png" width="16" height="16"/>
 </tile>
 <tile id="18">
  <image source="../Images/Tiles/Tile_right.png" width="16" height="16"/>
 </tile>
 <tile id="19">
  <image source="../Images/Tiles/Tile_tr.png" width="16" height="16"/>
 </tile>
 <tile id="20">
  <image source="../Images/Tiles/Tile_up.png" width="16" height="16"/>
 </tile>
 <tile id="21">
  <image source="../Images/Tiles/red_tile.png" width="16" height="16"/>
 </tile>
 <tile id="22">
